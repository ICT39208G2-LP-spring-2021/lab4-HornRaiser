...
try {
  ...
  $mail->Body    = 'http://93.177.181.232/lab3-HornRaiser/activate-user.php?token='. $Token.'';
  $mail->AltBody = 'http://93.177.181.232/lab3-HornRaiser/activate-user.php?token='. $Token.'';
